<template>
  <svg class="ui-loading" xmlns="http://www.w3.org/2000/svg" :height="size" :width="size" viewBox="0 0 100 100"
...
const { color: _color, size: _size } = toRefs(props);

const size = computed(() => parseInt(_size.value) + "px");
